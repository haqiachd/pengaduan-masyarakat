    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <input type="text" name="tgl_pengaduan" value="<?php echo date('d/mY'); ?>" class="form-control" readonly>
                </div>
                ...
                <font color="red">* Tipe file yang bisa diunggah adalah .jpg ,jpeg, .png, .gif</font>
                </div>
